...
class QuickstartUser(HttpUser):
    ...
    def profile(self):
         ...
         res = self.client.put(
             "https://lxp-api-prod.azure-api.net/ProdStage/courses/course-v1:WHOAcademy+CS101+2021/block-v1:WHOAcademy+CS101+2021+type@sequential+block@b2c8271fa6474b999033536452df8d90/position",
             data=payload,
             headers = headers
         )
    def on_start(self):
